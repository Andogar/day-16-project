...
/*************************************************************************************
------------ ANSWER -------------------
The variables are not what they claim to be. x is global and y is local. the console.log(y) that's
commented out would give you an error saying y isn't defined, since it's not on the global scope.
Console.log(x) however gives you "I'm a local variable".
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) would print out undefined and console.log(foo()); would print out "function hoistining"
because functions are pulled to the top when the browser parses through the document
**************************************************************************************/
...
(function(today){
  "use strict";
//YOUR CODE here
   var todayIs = new Date('6/12/2017');
...
/**************************************************************************************
------------ ANSWER -------------------
Inside the IFEE it will log the number 4 and outside the IFEE it will error out and say it's not defined.
**************************************************************************************/
